...
<div class="bg-white rounded-xl border border-gray-200 p-6 mt-6">
    ...
    <?php 
    if(!empty($form_err)){
        echo '<div class="bg-red-50 text-red-600 border border-red-200 p-3 rounded-lg mb-4 text-sm">' . $form_err . '</div>';
    }
    if(!empty($form_success)){
        echo '<div class="bg-green-50 text-green-600 border border-green-200 p-3 rounded-lg mb-4 text-sm">' . $form_success . '</div>';
    }
    ?>
    ...
    <form action="index.php?tab=add_customer" method="post">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="name" placeholder="Ad Soyad" required class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" />
            </div>
            <div>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Şirket / Kafe Adı</label>
                <input type="text" name="company" placeholder="Kafe Adı" class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" />
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">İl</label>
                <input type="text" name="city" placeholder="Şehir Adı" class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" />
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">İlçe</label>
                <input type="text" name="district" placeholder="İlçe Adı" class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" />
            </div>
            ...
            <div>
                ...
                <input type="date" name="start_date" required class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" />
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Bitiş Tarihi (*)</label>
                <input type="date" name="end_date" required class="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" />
            </div>
            <div class="md:col-span-2">
            ...
            <div class="md:col-span-2">
                <button type="submit" name="add_customer" class="px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition shadow-lg">
